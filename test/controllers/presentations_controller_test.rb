...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { comment_id: @presentation.comment_id, presentation_item_id: @presentation.presentation_item_id, status: @presentation.status } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { comment_id: @presentation.comment_id, presentation_item_id: @presentation.presentation_item_id, status: @presentation.status } }
