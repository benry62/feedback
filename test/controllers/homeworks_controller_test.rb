...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post homeworks_url, params: { homework: { class_group_id: @homework.class_group_id, date: @homework.date, title: @homework.title } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { class_group_id: @homework.class_group_id, date: @homework.date, title: @homework.title } }
